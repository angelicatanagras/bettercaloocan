# Request Special Collection Services for Hazardous Waste & E-Waste — City of Caloocan

Hazardous and electronic wastes (e-waste) cannot be disposed of with regular garbage. The City Environmental Management Department (CEMD) and barangays coordinate **special collection drives** and drop-off services for these items.
...
2. **Barangay forwards request to CEMD**
   - CEMD schedules a **special truck pickup** or directs you to the next citywide collection event.
...
4. **Follow the scheduled collection**
   - Place items outside only when instructed, or bring them to the barangay/CEMD drop-off point.
...
- **Accredited Junkshops/Collectors** — some accept electronics for recycling; ask CEMD for the accredited list.
...
✅ Always coordinate with your **Barangay Hall** or **CEMD** for proper and safe collection.
